...
Familiar options: query_catalogue, infrastructure_as_code, ci_cd_proces
...
New option: data_visualisation_tool, pub_sub

**AXIAL CODING TRACE:**

added:
``` python
    data_visualisation_tool = CClass(pattern, "Data Visualisation Tool")
    
    add_decision_option_link(data_product_anatomy_decision, data_visualisation_tool,
                             "Use a data visualisation tool to display data to the user")
