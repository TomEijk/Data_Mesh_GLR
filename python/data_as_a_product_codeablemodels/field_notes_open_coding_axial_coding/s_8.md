...
New code identified for creating data products -> Business Decision defines a Data Product
...
``` python 
     ...
     business_decision_as_data_product = CClass(practice, "Business Decision as a Data Product")
       
     add_decision_option_link(data_product_anatomy_decision, business_decision_as_data_product.
                                "Create data product based on business decision")
