...
Recognised option: internal_storage, business_decision_as_data_product
...
``` python
    ...
    add_force_relations({query_catalogue: {discoverable: positive},
...
Recognised option: shifting_responsibility_left, central_data_product_catalogue, immutable_change_audit_log
...
Recognised options: unified_batch_stream, data_visualisation_tool
...
Recognised options: k8s, pub_sub, containerisation, cloud_infrastructure_layer
